...
void createTrafficObjects_Paris(std::vector<std::shared_ptr<Street>> &streets, 
    ...
    std::string &filename, int nVehicles)
{
...
{
    // assign filename of corresponding city map
    filename = "../data/nycReferencia.jpg";
...
void createTrafficObjects_Qro(std::vector<std::shared_ptr<Street>> &streets, 
    std::vector<std::shared_ptr<Intersection>> &intersections, 
    std::vector<std::shared_ptr<Vehicle>> &vehicles, 
    std::string &filename, int nVehicles)
{
    // assign filename of corresponding city map
    filename = "../data/Queretaro.jpg";
    ...
    // position intersections in pixel coordinates
    intersections.at(0)->setPosition(544, 684);
    intersections.at(1)->setPosition(611, 821);
    intersections.at(2)->setPosition(880, 670);
    intersections.at(3)->setPosition(787, 437);
    intersections.at(4)->setPosition(1'054, 295);
    intersections.at(5)->setPosition(992, 43);
...
int main()
{
    ...
    // createTrafficObjects_Qro(streets, intersections, vehicles, backgroundImg, nVehicles);
